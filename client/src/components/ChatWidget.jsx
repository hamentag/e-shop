...
const ChatWidget = () => {
    ...
    return (
        <div className="chat-container position-fixed bottom-0 end-0 py-2 px-0 px-sm-1 p-md-3">
            <button
            ...
            {isOpen && (
                <div className="card shadow chat-box mt-2">
                    <div className="card-header d-flex justify-content-between align-items-center text-white py-2 px-3">
                        ...
                        <button className="btn btn-sm btn-light" onClick={toggleChat}><span><i className="bi bi-x-lg fs-5"></i></span></button>
                    </div>
